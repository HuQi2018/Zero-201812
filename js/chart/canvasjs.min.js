...
/*jshint ignore:start*/ (function() {
    ...
    var W = {}, v = !! document.createElement("canvas").getContext,
        qa = {
            Chart: {
                width: 500,
                height: 400,
    ...
    var Va = {}, pa = null,
        ...
        V = function(m, s, q) {
            ...
            s = null;
            for (var X =
                0; S && X < S.length; X++) if (s = S[X], "." === s && 0 > C) C = X;
                else {
                    if ("%" === s) z *= 100;
                    else if ("\u2030" === s) {
                        z *= 1E3;
    ...
    Ka.Chart = function() {
                    ...
                    if (c ||
                        b) for (var f = a.axisY.dataInfo, g = a.axisX.dataInfo, k, h = g.min, n = g.max, l = f.min, t = f.max, g = g._dataRanges, f = f._dataRanges, p, r = 0, m = 0; m < a.dataSeriesIndexes.length; m++) {
                            ...
                            if (!(4 > v.dataPoints.length)) for (r = 0; r < v.dataPoints.length; r++) if (c && (p = (n + 1 - h) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, k = v.dataPoints[r].x.getTime ? v.dataPoints[r].x.getTime() : v.dataPoints[r].x, p = Math.floor((k - h) / p), k < g[p].min && (g[p].min = k), k > g[p].max && (g[p].max = k)), b) {
                                        ...
                                        if ((k = "waterfall" === a.type ? v.dataPointEOs[r].cumulativeSum : v.dataPoints[r].y) && k.length) for (var s = 0; s < k.length; s++) p = Math.floor((k[s] - l) / q), k[s] < f[p].min && (f[p].min = k[s]), k[s] > f[p].max && (f[p].max = k[s]);
                ...
                for (var g = [], h, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (0 < r.length) {
                        for (var q = !1, u = 0; u < r.length; u++) if (Q = r[u].getTime ? r[u].x.getTime() : r[u].x, !(Q < a.axisX.dataInfo.viewPortMin || Q > a.axisX.dataInfo.viewPortMax &&
                                (!k.connectNullData || !q))) if ("number" !== typeof r[u].y) 0 < u && !(k.connectNullData || q || D) && (b.stroke(), v && c.stroke()), q = !0;
                                else {
                                    var s = H;
                                    Q = a.axisX.convertValueToPixel(Q);
                                    H = a.axisY.convertValueToPixel(r[u].y);
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < m.length) {
                        ...
                        for (var ca = !0; D < m.length; D++) if (q = m[D].x.getTime ? m[D].x.getTime() : m[D].x, !(q <
                                a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!w.connectNullData || !ca))) if ("number" !== typeof m[D].y) w.connectNullData || (ca || f) || c(), ca = !0;
                                else {
                ...
                for (y = 0; y < a.dataSeriesIndexes.length; y++) {
                    ...
                    if (0 < k.length) {
                        ...
                        for (var ca = !0, p = 0; p < k.length; p++) {
                            ...
                            if (!(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !ca))) if ("number" !== typeof aa.y) A.connectNullData || (ca || s) || f(), ca = !0;
                                else {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
                    var H = a.dataSeriesIndexes[s],
                        ...
                        C = 0;
                    if (A) for (e = x._linkedSeries.id, u = 0; u < e; u++)!this.data[u].type.match(/(bar|column)/ig) || !this.data[u].visible || this.data[u].type.match(/(stacked)/ig) && C || (this.data[u].type.match(/(range)/ig) && (g = !0), C++);
        ...
        q.prototype.renderFunnel = function(a) {
            ...
            function g() {
                ...
                else for (f = 0; f < N.length; f++) 0 == G[f].textBlock.text.length ? G[f].isDirty = !0 : (a = N[f], b = a.height, c = G[f].height, e = G[f].width, b >= c ? (b = f != fa ? (a.x4 + a.x3) / 2 - e / 2 : (a.x5 + a.x4) / 2 - e / 2, c = f != fa ? (a.y1 + a.y3) / 2 - c / 2 : (a.y1 + a.y4) / 2 - c / 2, G[f].textBlock.x = b, G[f].textBlock.y =
                            c) : G[f].isDirty = !0)
            }
            function h() {
                function a(b, c) {
                ...
                function c(a, b, d) {
                    ...
                    for (d = 0; d < e.length; d++) if (b = e[d], f < a) g++, f += G[b.id].height + ga, G[b.id].textBlock.text = "", G[b.id].indexLabelText = "", G[b.id].isDirty = !0, G[b.id].textBlock.measureText();
                        else break;
                    return g
                }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                if (0 != u.length && (u.dataPoints && u.visible) && 0 !== x.length) {
                    ...
                    if (-1 !== K) {
                        ...
                        else for (E = 0; E < K.length; E++) V += K[E], I.push(V); if (u.reversed) for (E = 0; E < K.length; E++) I[E] < ba ? (a.push(M), B.push(Z), fa = E) : (a.push((I[E] - T + ea * Y) / ea), B.push((I[E] - T + ha * X) / ha));
                        else for (E = 0; E < K.length; E++) I[E] < ba ? (a.push((I[E] - T + ea * Y) / ea), B.push((I[E] - T + ha *
                        ...
                        for (b = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; b < this._labels.length; b++) if (!this._labels[b].breaksLabelType) {
                                ...
                                if (y(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle) if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? h : Math.min((c - g * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), c), m = (k - (t + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI / 180 * Math.abs(-25)), !y(this.options.labelWrap)) this.labelWrap ? y(this.options.labelMaxWidth) ?
                                        ...
                                        if (y(this.options.labelWrap)) if (!y(this.options.labelMaxWidth)) this.options.labelMaxWidth < g ? (this.sessionVariables.labelMaxWidth =
                                            ...
                                            else if (!y(f)) if (c = q.width + f.width >> 0, d = this.labelFontSize, n < g) c - 2 * g > p && (p = c - 2 * g, c >= 2 * g && c < 2.2 * g ? (this.sessionVariables.labelMaxWidth = g, y(this.options.labelFontSize) && 12 < d && (d = Math.floor(12 / 13 * d), a.measureText()), this.sessionVariables.labelFontSize = y(this.options.labelFontSize) ? d : this.options.labelFontSize,
                                        ...
                                        else if (0 === p) for (this.sessionVariables.labelFontSize = y(this.options.labelFontSize) ? d : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, c = 0; c < this._labels.length; c++) a =
        ...
        C.setLayoutAndRender = function(a, f, b, c,
            ...
            if ("normal" === e) {
                for (var z = [], C = [], F = [], B = [], P = [], R = [], S = [], T = []; 4 > s;) {
                    ...
                    S.push(F);
                    if (c && 0 < c.length) for (B = [], d = ba = 0; d < c.length; d++) B.push(Math.ceil(c[d] ? c[d].createLabelsAndCalculateWidth() : 0)), ba += B[d], $ += c[d] ? c[d].margin : 0;
                    ...
                    if (0 < s) {
                        ...
                        else q = !0; if (f && 0 < f.length) for (d = 0; d < f.length; d++) L = R[s - 1][d] === R[s][d] ? !0 : !1;
                        else L = !0; if (b && 0 < b.length) for (d = 0; d < b.length; d++) K = S[s - 1][d] === S[s][d] ? !0 : !1;
                        else K = !0; if (c && 0 < c.length) for (d = 0; d < c.length; d++) O = T[s - 1][d] === T[s][d] ? !0 : !1;
                        else O = !0
                    }
                    if (q && L && K && O) break;
                    s++
                ...
                for (S = []; 4 > s;) {
                    ...
                    if (a && 0 < a.length) for (x = [], d = Z = 0; d < a.length; d++) x.push(Math.ceil(a[d] ? a[d].createLabelsAndCalculateWidth() : 0)), Z += x[d], e += a[d] ? a[d].margin : 0;
                    else x.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
                    R.push(x);
                    if (f && 0 < f.length) for (I = [], d = V = 0; d < f.length; d++) I.push(Math.ceil(f[d] ? f[d].createLabelsAndCalculateWidth() : 0)), V += I[d], W += f[d] ? f[d].margin : 0;
                    ...
                    if (b && 0 < b.length) for (A = [], d = X = 0; d < b.length; d++) A.push(Math.ceil(b[d] ? b[d].createLabelsAndCalculateHeight() : 0)), X += A[d] + b[d].margin, M += b[d].margin;
                    else A.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() : 0));
                    u.push(A);
                    if (c && 0 < c.length) for (J = [], d = N = 0; d < c.length; d++) J.push(Math.ceil(c[d] ? c[d].createLabelsAndCalculateHeight() : 0)), N += J[d], $ += c[d].margin;
                    ...
                    else for (d = 0; d < b.length; d++) m.sessionVariables.axisY.height = A[d]; if (b && 0 < b.length) for (d = b.length - 1; 0 <= d; d--) l = Math.round(g.y2), k = Math.round(g.y2 > b[d].chart.height - 10 ? b[d].chart.height - 10 : g.y2), b[d].lineCoordinates.y1 = l - (A[d] + b[d].margin + E), b[d].lineCoordinates.y2 = l - (A[d] + b[d].margin + E), b[d].bounds = {
                                x1: h,
                    ...
                    for (d = 0; d < n.length; d++) "axisY" === n[d].type && (n[d].calculateValueToPixelConversionParameters(), n[d].calculateBreaksSizeInValues());
                    if (0 < s) {
                        if (a && 0 < a.length) for (d = 0; d < a.length; d++) q = R[s - 1][d] === R[s][d] ? !0 : !1;
                        else q = !0; if (f && 0 < f.length) for (d = 0; d < f.length; d++) L = S[s - 1][d] === S[s][d] ? !0 : !1;
                        else L = !0; if (b && 0 <
                            b.length) for (d = 0; d < b.length; d++) K = u[s - 1][d] === u[s][d] ? !0 : !1;
                        else K = !0; if (c && 0 < c.length) for (d = 0; d < c.length; d++) O = P[s - 1][d] === P[s][d] ? !0 : !1;
                        else O = !0
                    }
                    if (q && L && K && O) break;
                    s++
        ...
        C.prototype.renderLabelsTicksAndTitle = function() {
            ...
            else for (k = 0; k < this._labels.length; k++) p = this._labels[k], p.position < this.viewportMinimum || (p.position > this.viewportMaximum || f && 0 !== g++ % 2 && this.labelAutoFit) || p.textBlock.render(!0)
        };
        C.prototype.renderInterlacedColors = function() {
            ...
            else if (("left" === this._position || "right" === this._position) && this.interlacedColor) for (a.fillStyle =
        ...
        C.prototype.renderAxisLine = function() {
            ...
            if ("bottom" === this._position || "top" === this._position) {
                ...
                if (this.scaleBreaks && !y(this.scaleBreaks.firstBreakIndex)) if (y(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + b;
                    else for (l = this.scaleBreaks.firstBreakIndex; l <= this.scaleBreaks.lastBreakIndex; l++) f.moveTo(h, e), f.lineTo(h, this.scaleBreaks._appliedBreaks[l].startPixel + c),
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if ("rangeBar" === h[0].dataSeries.type || "error" === h[0].dataSeries.type) for (var d = Math.abs(a - this.parent.convertValueToPixel(h[q].dataPoint.y[0])),
                                s = 0, n = 0; n < h.length; n++) if (h[n].dataPoint.y && h[n].dataPoint.y.length) for (m = 0; m < h[n].dataPoint.y.length; m++) s = Math.abs(a - this.parent.convertValueToPixel(h[n].dataPoint.y[m])), s < d && (d = s, q = n);
                            else s = Math.abs(a - this.parent.convertValueToPixel(h[n].dataPoint.y)), s < d && (d = s, q = n);
                            else if ("stackedBar" === h[0].dataSeries.type) for (var d = Math.abs(a - this.parent.convertValueToPixel(h[0].dataPoint.y)), v = s = 0, n = q = 0; n < h.length; n++) if (h[n].dataPoint.y && h[n].dataPoint.y.length) for (m = 0; m < h[n].dataPoint.y.length; m++) s = Math.abs(a -
                    ...
                    if ("rangeColumn" === h[0].dataSeries.type || "rangeArea" === h[0].dataSeries.type || "error" === h[0].dataSeries.type || "rangeSplineArea" === h[0].dataSeries.type || "candlestick" === h[0].dataSeries.type || "ohlc" === h[0].dataSeries.type || "boxAndWhisker" === h[0].dataSeries.type) for (d = Math.abs(f - this.parent.convertValueToPixel(h[0].dataPoint.y[0])),
                            n = s = 0; n < h.length; n++) if (h[n].dataPoint.y && h[n].dataPoint.y.length) for (m = 0; m < h[n].dataPoint.y.length; m++) s = Math.abs(f - this.parent.convertValueToPixel(h[n].dataPoint.y[m])), s < d && (d = s, q = n);
                            else s = Math.abs(f - this.parent.convertValueToPixel(h[n].dataPoint.y)), s < d && (d = s, q = n);
                            else if ("stackedColumn" === h[0].dataSeries.type || "stackedArea" === h[0].dataSeries.type) for (d = Math.abs(f - this.parent.convertValueToPixel(h[0].dataPoint.y)), n = v = s = 0; n < h.length; n++) if (h[n].dataPoint.y && h[n].dataPoint.y.length) for (m = 0; m <
                            ...
                            else if ("stackedColumn100" === h[0].dataSeries.type || "stackedArea100" === h[0].dataSeries.type) for (d = Math.abs(f - this.parent.convertValueToPixel(h[0].dataPoint.y)), n = u = v = s = 0; n < h.length; n++) if (h[n].dataPoint.y && h[n].dataPoint.y.length) for (m = 0; m < h[n].dataPoint.y.length; m++) s = Math.abs(f - this.parent.convertValueToPixel(h[n].dataPoint.y[m])),
                    s < d && (d = s, q = n);
                                    ...
                                    this.parent.convertValueToPixel(h[n].dataPoint.y)), s < d && (d = s, q = n); m = h[q];
                    b = 0;
