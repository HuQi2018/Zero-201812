...
(function(i, f, c, k, d, l, h) { /*! Jssor */
    ...
    var b = i.$Jssor$ = new function() {
            ...
            function tb(a, c, e, b) {
                b = b || "u";
                for (a = a ? a.firstChild : k; a; a = a.nextSibling) if (a.nodeType == 1) {
                        if (X(a, b) == c) return a;
                        if (!e) {
                            var d = tb(a, c, e, b);
                            if (d) return d
            ...
            function w(f, l) {
                ...
                w = function(e, c) {
                    ...
                    if (c.me) if (d) yb(g.$CreateCallback(k, O, e, c));
                        else a(e, c)
                };
                g.Db = O;
                if (d) g.Db = w;
    ...
    var m = function(z, C, h, L, O, J) {
        ...
        if (b.$IsBrowserSafari() && b.$BrowserVersion() < 7) r = k;
        r = r || function(a) {
        ...
        function i(g, f) {
            ...
            a.He = function(c, b) {
                ...
                if (!a.Sb[f]) {
                    ...
                    for (var d = 0; d < a.$Cols; d++) for (var e = 0; e < a.$Rows; e++) a.Sb[f][e + "," + d] = {
                                $Top: e * b,
                                $Right: d * c + c,
                                $Bottom: e * b + b,
                                $Left: d * c
        ...
        function o(B, h, a, w, o, m) {
            ...
            b.$Each(p, function(h, k) {
                b.$Each(h, function(G) {
                    ...
                    if (a.$Zoom || a.$Rotate) {
                        var H = d;
                        if (b.gb()) if (a.$Cols * a.$Rows > 1) H = l;
                            else I = l;
                        if (H) {
            ...
            function T(a, c, e) {
                ...
                b.$Each(f, function(f) {
                    ...
                    if (i == "caption") {
                        ...
                        if (h == "A") {
                            if (b.$AttributeEx(f, "u") == "image") o = b.xf(f, "IMG");
                            else o = b.$FindChild(f, "image", d); if (o) {
                                w = f;
                                b.bb(w, "block");
                                b.K(w, V);
                                B = b.$CloneNode(w, d);
